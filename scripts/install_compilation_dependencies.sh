...
sudo apt install -y ack antlr3 aria2 libfuse-dev clang-13 asciidoc autoconf automake autopoint b43-fwcutter binutils bison build-essential bzip2 ccache cmake cpio curl device-tree-compiler fastjar flex gawk gettext \
...
rsync unzip zlib1g-dev wget || sudo apt install -y ack antlr3 aria2 asciidoc autoconf automake autopoint b43-fwcutter binutils bison build-essential bzip2 ccache cmake cpio curl device-tree-compiler fastjar \
